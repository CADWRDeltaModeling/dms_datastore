...
srh = srh.mask((srh < 10.0) | (srh > 400.0))
approx_bias = 25.0
...
lisbon_cdec = med_outliers(
    lisbon_cdec, level=4, quantiles=(0.01, 0.99), range=(50, 1500)
)
...
salt[columns].to_csv(
    "salt_new.th", date_format="%Y-%m-%dT%H:%M", float_format="%4.2f", sep=" "
)
