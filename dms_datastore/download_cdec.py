...
def create_arg_parser():
    ...
    parser.add_argument('--dest', dest="dest_dir", default="cdec_download",
    ...
    parser.add_argument('--param_col', type=str, default=None,
...
def cdec_download(stations, dest_dir, start, end=None, param=None, overwrite=False, freq=None):
    ...
    subloc_inconsist = stations.subloc.isin(["lower", "bot", "bottom"]) & ~stations.src_var_id.isin([
                                            92, 102])   # at present, only EC has bottom sensor listed
    stations = stations.loc[~subloc_inconsist, :]
