rem This file represents data acquisition and reformatting used in the repo
rem when done on a standalone computer
...
call c:\Users\eli\miniconda3\Scripts\activate.bat schism
