...
def data_inventory(fpath,full=True,by="file_pattern"):
    ...
    grouped_meta.columns = ['station_id','param','source',
...
if __name__ == "__main__":
    data_inventory("W:/continuous_station_repo_beta/formatted_1yr")
