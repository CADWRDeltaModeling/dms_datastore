...
setup(
    ...
    package_data = {'dms_datastore' : ['config_data/*.csv','config_data/*.yaml','usgs_parameter_cd_query.txt','config_data/*.shp','config_data/*.prj','config_data/*.dbf','config_data/*.txt']},
